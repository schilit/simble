...
// What is left here is what this page still differs on. The device card, its
// dot, its pen icon and its address used to be styled here; they now come from
// common/device-header.js and common/simble.css, and the copy below them had
// stopped matching anything the module renders.
const STYLE = `.row { display: flex; gap: 0.5rem; align-items: center; margin: 0.55rem 0; flex-wrap: wrap; }
...
.svc-head { background: var(--panel2); padding: 0.4rem 0.7rem; font-size: var(--fs-body); font-weight: 500; }
