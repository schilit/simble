...
|---|---|---|---|---|
| **CSR8510 A10** | **Ezurio (Laird) BT820** — `BT820-ND` ([DigiKey](https://www.digikey.com/en/products/detail/laird-connectivity-inc/BT820/4423863), [Newark](https://www.newark.com/laird-technologies/bt820/usb-dongle-bluetooth-bt800-v4/dp/08X8202), [Ezurio](https://www.ezurio.com/part/bt820)) — a packaged, distributor-stocked dongle on this chipset.<br>The same silicon is also sold unbranded as a generic "Bluetooth 4.0 USB adapter" (`0a12:0001`) for under $10; both enumerate identically | 4.0 | Real RF, real timing, a real peer: advertising, scanning, connections, GATT | ✅ two of them link and discover over the air (`tests/usb_hardware_test.rs`) |
